...
//-------------
string NODETYPE_name[20] = {"null_node","const","var","array","expr","type","stmt","block","program","function","params","12"};
string StmtType_name[30] = {"block","skip","decl const", "decl var","decl ptr","decl ref","decl array","assign","add_assign","sub_assign","mul_assign","div_assign",
...
//构造函数，初始化，序号自增
TreeNode::TreeNode(int _lineno, NodeType _type) 
{
    node_num++;
    //第一件事，序号自增,记录行号
