...
public:
    ...
    //TYPE
        ...
        Type *type,*func_type;  // 对于常量+变量、类型（用于声明或定义）、表达式结点，有类型。 定义在type.h
    //STMT
    ...
    //CONST
        ...
        //----------决定变量类型！！！！！！
        string type_flag;//'i' 'c' 'b' 's' 'p'  
        //VAR
        string var_name,func_name;//变量名 or 数组名共用
        int arr_d[4];// 数组维度？
    ...
    public:
        ...
        TreeNode(int _lineno, NodeType _type);
